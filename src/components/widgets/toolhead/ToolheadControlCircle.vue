        ...
        >
          ...
          <g>
            ...
            >
              ...
              <text transform="translate(31.671 332.167)">
                XY
              </text>
            </a>
...
export default class ToolheadControlCircle extends Mixins(StateMixin, ToolheadMixin) {
  ...
  get xStepClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || !this.xHomed)
    }
  }

  get yStepClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || !this.yHomed)
    }
  }

  get zStepClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || !this.zHomed)
    }
  }

  get xyStepClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || !(this.xHomed || this.yHomed))
    }
  }
  ...
  get yHomeClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || this.hasWait([this.$waits.onHomeY, this.$waits.onHomeXY, this.$waits.onHomeAll])),
      primary: !this.yHomed
    }
  }
  ...
  get zHomeClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || this.hasWait([this.$waits.onHomeZ, this.$waits.onHomeAll])),
      primary: !this.zHomed
    }
  }
  ...
  get xyHomeClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || this.hasWait([this.$waits.onHomeX, this.$waits.onHomeY, this.$waits.onHomeXY, this.$waits.onHomeAll])),
  ...
  get xyzHomeClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || this.hasWait([this.$waits.onHomeX, this.$waits.onHomeY, this.$waits.onHomeZ, this.$waits.onHomeXY, this.$waits.onHomeAll])),
  ...
  get centerToolheadClasses () {
    ...
    return {
      disabled: (!this.klippyReady || this.printerPrinting || !this.xyHomed),
      primary: !(tool_pos[0] === bedCenter.x && tool_pos[1] === bedCenter.y)
    }
  }
  ...
  get levelingClasses () {
    const [primary, disabled] = this.printerSupportsQuadGantryLevel
      ...
      : this.printerSupportsZTiltAdjust
        ...
        : []
    return {
      disabled: (!this.klippyReady || this.printerPrinting || !this.allHomed || disabled),
      primary
    }
  }
  ...
  get motorsOffClasses () {
    return {
      disabled: (!this.klippyReady || this.printerPrinting || !this.hasSteppersEnabled)
    }
  }
