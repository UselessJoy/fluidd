        ...
        <v-card-text>
          ...
          >
            <thead class="font-weight-medium">
              <tr>
                <th style="font-size: 16px;"> {{ $t('app.diagnostics.label.tools') }} </th>
              </tr>
            </thead>
            <tbody>
              <tr>
              ...
              > -->
                <td>
                  <th>Ventilyatori</th>
                  <outputs :onlyControllable="true"/>
                </td>
                <td>
                  <v-checkbox :label="$t('app.diagnostics.success')" color="success"></v-checkbox>
                </td>
              </tr>
              <tr>
                <td>
